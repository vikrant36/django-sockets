...
let pcConfig = {
    "iceServers":
        [
            { "url": "stun:127.0.0.1:5349" },
            {
                "url": "turn:127.0.0.1:5349",
                "username": "guest",
...
function beReady() {
    return navigator.mediaDevices.getUserMedia({
        ...
        .then(stream => {
            ...
            console.log('streamb:', stream);
            console.log('streama: print')
...
function createConnectionAndAddStream() {
    console.log('streamc')
    console.log('streamc:', localStream)
...
function handleRemoteStreamAdded(event) {
    ...
    console.log('streama:', remoteStream)
